...
ACLOCAL = ${SHELL} "/root/Projects/android/external/curl/missing" --run aclocal-1.13
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 1
AR = /usr/bin/ar
AS = as
AUTOCONF = ${SHELL} "/root/Projects/android/external/curl/missing" --run autoconf
AUTOHEADER = ${SHELL} "/root/Projects/android/external/curl/missing" --run autoheader
AUTOMAKE = ${SHELL} "/root/Projects/android/external/curl/missing" --run automake-1.13
AWK = mawk
BLANK_AT_MAKETIME = 
CC = arm-linux-androideabi-gcc
CCDEPMODE = depmode=gcc3
CFLAGS = -fno-exceptions -Wno-multichar -mthumb -mthumb-interwork -nostdlib -L/root/Projects/android/out/target/product/generic/obj/lib -L/root/Projects/android/out/target/product/generic/system/lib -isystem /root/Projects/android/external/openssl/include -lc -ldl -lm -lssl -O2 -Wno-system-headers
CFLAG_CURL_SYMBOL_HIDING = -fvisibility=hidden
CONFIGURE_OPTIONS = " 'CC=arm-linux-androideabi-gcc' '--host=arm-linux' '--disable-tftp' '--disable-sspi' '--disable-ipv6' '--disable-ldaps' '--disable-ldap' '--disable-telnet' '--without-ssl' '--disable-imap' '--disable-smtp' '--disable-pop3' '--disable-ares' '--without-ca-bundle' '--disable-warnings' '--disable-manual' '--without-nss' '--enable-shared' '--without-zlib' '--without-random' 'host_alias=arm-linux' 'CFLAGS=-fno-exceptions -Wno-multichar -mthumb -mthumb-interwork -nostdlib -L/root/Projects/android/out/target/product/generic/obj/lib -L/root/Projects/android/out/target/product/generic/system/lib -I/root/Projects/android/external/openssl/include -lc -ldl -lm -lssl' 'CPPFLAGS=-I /root/Projects/android/system/core/include -I/root/Projects/android/bionic/libc/include -I/root/Projects/android/bionic/libc/arch-arm/include -I/root/Projects/android/external/kernel-headers/original -I/root/Projects/android/bionic/libc/kernel/arch-arm -L/root/Projects/android/out/target/product/generic/obj/lib -L/root/Projects/android/out/target/product/generic/system/lib -lc -ldl -lm -lssl '"
CPP = arm-linux-androideabi-gcc -E
CPPFLAGS = -isystem /root/Projects/android/system/core/include -isystem /root/Projects/android/bionic/libc/include -isystem /root/Projects/android/bionic/libc/arch-arm/include -isystem /root/Projects/android/external/kernel-headers/original -isystem /root/Projects/android/bionic/libc/kernel/arch-arm -L/root/Projects/android/out/target/product/generic/obj/lib -L/root/Projects/android/out/target/product/generic/system/lib -lc -ldl -lm -lssl
...
IPV6_ENABLED = 
KRB4_ENABLED = 
LD = /root/Projects/android/prebuilts/gcc/linux-x86/arm/arm-linux-androideabi-4.6/arm-linux-androideabi/bin/ld
LDFLAGS = 
LIBCURL_LIBS = 
...
LTLIBOBJS = 
MAINT = #
MAKEINFO = ${SHELL} "/root/Projects/android/external/curl/missing" --run makeinfo
MANIFEST_TOOL = :
MANOPT = -man
MKDIR_P = /bin/mkdir -p
NM = nm
...
STRIP = strip
SUPPORT_FEATURES = 
SUPPORT_PROTOCOLS = DICT FILE FTP GOPHER HTTP RTSP
USE_ARES = 
USE_AXTLS = 
USE_CYASSL = 
USE_DARWINSSL = 
...
VERSIONNUM = 072000
ZLIB_LIBS = 
abs_builddir = /root/Projects/android/external/curl
abs_srcdir = /root/Projects/android/external/curl
abs_top_builddir = /root/Projects/android/external/curl
abs_top_srcdir = /root/Projects/android/external/curl
ac_ct_AR = 
ac_ct_CC = 
...
install_sh = ${SHELL} /root/Projects/android/external/curl/install-sh
...
am--refresh: Makefile
	@:
$(srcdir)/Makefile.in: # $(srcdir)/Makefile.am $(srcdir)/lib/Makefile.inc $(am__configure_deps)
	@for dep in $?; do \
